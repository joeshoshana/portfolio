...
public class CaesareaBuilder extends ModuleBuilder {

    public CaesareaBuilder(ModuleConfiguration config) {
        _config = config;
        _module = new Caesarea(_config);
    }
