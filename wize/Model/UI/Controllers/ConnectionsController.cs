...
namespace UI.Controllers
{
    public class ConnectionsController : Controller
    {
        ...
        public ActionResult Get(string data)
        {
            ...
            if (item == null)
                item = new sp_GetConnections_Result();
            ...
            items = Models.Utilities.TableManipulation<sp_GetConnections_Result>(items, Request.Form);
        ...
        public ActionResult Save(string data)
        {
            try
            {
                ...
                bool isValid = true;
                isValid = ConnectionsHandler.Validate("CompanyID", item, ref errors);
        ...
        public ActionResult Delete(string data)
        {
            try
            {
                ...
                ConnectionsHandler.Delete(item);
